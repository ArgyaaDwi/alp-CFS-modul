            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('fgm.profile') }}"> Halaman Profil
                            </a></li>
            ...
            <div class="row">
                <div class="col-md-13 mb-4">
                    <div class="card  card-outline mx-1">
                        <div class="m-4">
                            <form class="form-horizontal" action="{{ route('fgm.profile.update', $user->id) }}"
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-2 col-sm-10">
                                        <a href="{{ route('fgm.profile') }}" class="btn btn-secondary"><i
