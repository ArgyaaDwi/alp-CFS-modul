                ...
                <form action="{{ route('sales.distributor.save') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="{{ old('company_name') }}" id="company_name" name="company_name"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="email" id="company_email" value="{{ old('company_email') }}" name="company_email"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" id="company_phone" value="{{ old('company_phone') }}" name="company_phone"
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="company_website" value="{{ old('company_website') }}" name="company_website"
                                class="form-control" placeholder="Masukkan Website Perusahaan">
                            <small class="text-muted"><i class="fas fa-info-circle"></i> (Opsional) Masukkan link URL website distributor jika
                                ada</small>
                        </div>
                    </div>
