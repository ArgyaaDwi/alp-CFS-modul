    ...
    <section class="content">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card mx-2">
                        <div class="card-header">
                            <h3>{{ $distributors->company_name }}</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card mx-2 py-5">
                        <img src="{{ asset('images/company.png') }}" height="215px" class="card-img-top" alt="Gambar Perusahaan">
                    </div>
                </div>
            </div>
        </div>
