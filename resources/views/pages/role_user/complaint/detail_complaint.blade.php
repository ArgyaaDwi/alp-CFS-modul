                                ...
                                <div class="card-body d-flex flex-column pt-3">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active mx-1" id="info" role="tabpanel"
                                            ...
                                            <p>Kategori: @foreach ($complaint->categories as $category)
                                            ...
                                            @if ($complaint->supporting_document)
                                                <button class="btn btn-primary my-2"><a class="text-white"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-body">
                                                                        <span class="text-bold ">Status: {{ $item->complaintStatus->status_name }}</span><br>
                                                                        <span class=" ">Komentar: <br></span>
                                                                        {{ $item->notes }}
                                                                    </div>
