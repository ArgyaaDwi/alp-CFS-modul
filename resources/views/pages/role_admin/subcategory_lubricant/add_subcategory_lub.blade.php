...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0"><b>Tambah Sub Kategori</b></h4>
                </div>
                <div class="col-sm-6">
        ...
        <div class="card mx-2">
            <div class="card-body">
                <form action="{{ route('admin.subcategory.save') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="category_lubricant_id" class="form-labe required">Kategori</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="sub_category_name" class="form-label required">Nama Sub Kategori</label>
                                <input type="text" value="{{ old('sub_category_name') }}" id="sub_category_name" name="sub_category_name"
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            <label for="sub_category_description" class="form-label required">Deskripsi Kategori</label>
