    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <h4 class="m-0"><b>Kelola Produk</b></h4>
                </div>
                <div class="col-sm-6">
                    ...
                    <tbody>
                        @forelse ($products as $val)
                            <tr>
                                ...
                                <td><button type="button" disabled
                                        class="btn btn-outline-dark btn-sm">{{ $val->subCategoryLubricant->sub_category_name }}</button>
                                </td>
                                <td>
                                    <form action="{{ route('admin.product.delete', $val->id) }}" method="POST"
                                        id="delete-form-{{ $val->id }}">
                                        @csrf
                                        @method('DELETE')
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('admin.product.detail', $val->id) }}"
                                                class="btn btn-outline-info">
                                                <i class="fa-regular fa-eye"></i>
                                            </a>
                                            @auth
                                                <a href="{{ route('admin.product.edit', $val->id) }}"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Apakah kamu yakin ingin menghapus <span
                                                    class="text-danger text-bold">{{ $val->product_name }}</span> dari
                                                produk?
                                            </div>
