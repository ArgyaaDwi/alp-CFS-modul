                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td align="left" style="padding: 10px; font-size: 14px;">
                            <strong>CFS Ticket: CFS/12121/2/21212</strong><br>
                            <span style="color: black">Distributor terkait:
                                PT. ALP Petro Industry</span><br><br>

                            <span style="color: black">Yth. Udin Kamaludin</span><br>
                            <span style="color: black">Kami informasikan bahwa aduan yang Anda sampaikan dengan nomor
                                tiket CFS/12121/2/21212 telah mengalami perubahan
                                status.</span><br><br>

                            <span style="color: black">Status sekarang: <span
                                    style="color: black; font-weight: bold">Ditolak</span></span>
                            ...
                            <em>Selasa, 20 Februari 2023 10:00:00</em>
                            <br> oleh Udin Kamaludin<br><br>
